...
const Q4ex1ex3 = (props) => {
  ...
  const UpdateOnDB=async()=>{
    ...
    Nice work! The points for Elena, Karla, and Faye add up to 114, so that seems correct! So who scored the most?
    </Text>
